        ...
        <CardContent className="space-y-4 sm:space-y-6 relative px-4 sm:px-6 lg:px-8 pb-6 sm:pb-8">
          ...
          <div className="pt-4 sm:pt-6 border-t border-gray-200">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-6">
              ...
              <a href="mailto:support@orbosis.org" className="flex items-center justify-center sm:justify-start gap-2 text-blue-600 hover:text-blue-700 transition-colors">
