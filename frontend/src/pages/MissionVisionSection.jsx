            ...
            return (
              ...
              >
                <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4 lg:space-x-6">
                  <div className={`p-3 sm:p-4 rounded-full ${item.iconBg} border-2 ${item.borderColor} w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center flex-shrink-0 mx-auto sm:mx-0`}>
